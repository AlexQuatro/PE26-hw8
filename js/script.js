...
1. Опишіть своїми словами як працює метод forEach.
	...
	Метод forEach перебирає кожен елемент масиву і виконує з кожним елементом callBack-функцію.
...
2. Які методи для роботи з масивом мутують існуючий масив, а які повертають новий масив? Наведіть приклади.
	...
	slice, concat, filter, map - не мутують вихідний масив і повертають новий масив
